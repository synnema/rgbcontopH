...
PORTD=0b00000010;_delay_ms(210);PORTD=0b00000000;
while(1)
{
...
if (PINC & (1<<PC1)) {PORTD=0b00000111;_delay_ms(100);PORTD=0b00000000;}
...
//if ((h==21) && (m==3) && (s==1)) {PORTD=0b00000010;_delay_ms(150);PORTD=0b00000000;}

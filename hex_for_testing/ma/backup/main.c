...
if (h>23) {h=0;m=0;s=0;}
_delay_ms(1001);
if ((h==20) && (m==50) && (s==0))  {PORTD=0b00000010;_delay_ms(100);PORTD=0b00000000;}      //start maliny a synchron času
if ((h==21) && (m==10) && (s==0))  {PORTD=0b00000010;_delay_ms(100);PORTD=0b00000000;}      //zastavení maliny 
if ((h==21) && (m==0) && (s==15))  {PORTD=0b00000001;_delay_ms(100);PORTD=0b00000000;}

...
while (1)
    {
    for(i=z;i<255;i=i+y) {OCR1AL=i;_delay_ms(20);}
    for(i=255;i>z;i=i-y) {OCR1AL=i;_delay_ms(20);}
    for(i=z;i<255;i=i+y) {OCR1BL=i;_delay_ms(20);}
    for(i=255;i>z;i=i-y) {OCR1BL=i;_delay_ms(20);}
    for(i=z;i<255;i=i+y) {OCR2=i;_delay_ms(20);}
    for(i=255;i>z;i=i-y) {OCR2=i;_delay_ms(20);}
